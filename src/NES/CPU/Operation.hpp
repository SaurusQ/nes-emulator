...
#include "CPU.hpp"
using InstructionType = ::CPU::InstructionType;
    ...
    struct Operation
    {
        inline static bool execute(CPU& cpu, uint8_t mem, uint16_t targetAddress)
        {
            switch (IT)
            {
                ...
                case ASL:
                    {
                        ...
                        {
                            cpu.mapper_.write(targetAddress, mem);
                        }
                        return false;
                    }
                case BCC:
                ...
                case BRK:
                    {
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), getHighByte(cpu.registers_.PC));
                        cpu.registers_.SP--;
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), getLowByte(cpu.registers_.PC));
                        cpu.registers_.SP--;
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), cpu.registers_.P.reg);
                        cpu.registers_.SP--;
                ...
                case JSR:
                    {
                        ...
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), getHighByte(returnAddress));
                        cpu.registers_.SP--;
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), getLowByte(returnAddress));
                        cpu.registers_.SP--;
                        cpu.registers_.PC = targetAddress;
                        return false;
                    }
                ...
                case LSR:
                    {
                        ...
                        else cpu.mapper_.write(targetAddress, mem);
                ...
                case PHA:
                    {
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), cpu.registers_.A);
                        cpu.registers_.SP--;
                        return false;
                    }
                case PHP:
                    {
                        cpu.mapper_.write(spToAddr(cpu.registers_.SP), bAsHigh(cpu.registers_.P.reg));
                        cpu.registers_.SP--;
                        return false;
                    }
                case PLA:
                    {
                        cpu.registers_.SP++;
                        cpu.mapper_.read(spToAddr(cpu.registers_.SP), cpu.registers_.A);
                        setZN(cpu.registers_.P, cpu.registers_.A);
                        return false;
                    }
                case PLP: // TODO IRQ
                    {
                        cpu.registers_.SP++;
                        uint8_t byte;
                        cpu.mapper_.read(spToAddr(cpu.registers_.SP), byte);
                ...
                case RTI:
                    {
                        ...
                        cpu.registers_.P.reg = readStatusWithoutUB(cpu.registers_.P.reg, byte);
                        cpu.registers_.SP++;
                        cpu.mapper_.read(spToAddr(cpu.registers_.SP), low);
                        cpu.registers_.SP++;
                        cpu.mapper_.read(spToAddr(cpu.registers_.SP), high);
                ...
                case SAX: // Unofficial
                    {
                        ...
                        cpu.mapper_.write(targetAddress, byte);
                        return false;
                    }
                case SBC:
                    {
                ...
                case STA:
                    {
                        cpu.mapper_.write(targetAddress, cpu.registers_.A);
                        return false;
                    }
                case STX:
                    {
                        cpu.mapper_.write(targetAddress, cpu.registers_.X);
                        return false;
                    }
                case STY:
                    {
                        cpu.mapper_.write(targetAddress, cpu.registers_.Y);
                        return false;
                    }
                case TAX:
                    {
